...
final class Version20240321092304 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE candidate (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, experience_id INT DEFAULT NULL, gender TINYINT(1) NOT NULL, first_name LONGTEXT NOT NULL, last_name LONGTEXT NOT NULL, adress LONGTEXT NOT NULL, country LONGTEXT NOT NULL, nationality LONGTEXT NOT NULL, passport TINYINT(1) NOT NULL, passport_file VARCHAR(255) NOT NULL, curriculum_vitae VARCHAR(255) NOT NULL, profil_picture VARCHAR(255) NOT NULL, current_location LONGTEXT NOT NULL, date_of_birth DATE NOT NULL, place_of_birth LONGTEXT NOT NULL, email_adress VARCHAR(255) NOT NULL, confirm_email VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, confirm_password VARCHAR(255) NOT NULL, availability TINYINT(1) NOT NULL, job_category VARCHAR(255) NOT NULL, short_description LONGTEXT NOT NULL, notes LONGTEXT NOT NULL, date_created DATE NOT NULL, date_updated DATE NOT NULL, date_deleted DATE NOT NULL, files VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_C8B28E44A76ED395 (user_id), INDEX IDX_C8B28E4446E90E27 (experience_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
