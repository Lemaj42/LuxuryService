 ...
 */
final class Version20240319104550 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE job (id INT AUTO_INCREMENT NOT NULL, job_type_id INT NOT NULL, job_category_id INT NOT NULL, reference VARCHAR(255) NOT NULL, client VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, active TINYINT(1) NOT NULL, notes LONGTEXT NOT NULL, job_title LONGTEXT NOT NULL, location VARCHAR(255) NOT NULL, closing_date DATE NOT NULL, salary VARCHAR(255) NOT NULL, date_creation DATE NOT NULL, INDEX IDX_FBD8E0F85FA33B08 (job_type_id), INDEX IDX_FBD8E0F8712A86AB (job_category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
